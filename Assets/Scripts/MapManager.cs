...
public class MapManager : MonoBehaviour
{
    ...
    // 消除特效预设体
    public GameObject matchEffPrefab;
    // 连线
    ...
    public void Test()
    {
        GridCell a = grids[1, 1];
        GridCell b = grids[2, 1];
        Debug.Log(a.pos + "_" + a.item.type + "_" + a.view.worldPos);
        Debug.Log(b.pos + "_" + b.item.type + "_" + b.view.worldPos);
            ...
            else
            {
                ...
                if (CanMatch(firstSelected, secondSelected, true)) 
                {
                    ...
                    if (EmptyGrids())
                    {
                        ...
                        VictoryPanel.Instance.Show(spendTime);
